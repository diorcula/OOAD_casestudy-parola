...
public class Quiz {
    ...
    public Quiz mockedQuiz(){
        ...
        MeerkeuzeVraag vraag1 = new MeerkeuzeVraag("Wat is 2x2?", "Wiskunde", "1", "2", "3", "4");
        mockedQuiz.addVraag(vraag1);

        Kortantwoordvraag vraag2 = new Kortantwoordvraag("Voornaam van de koningin?", "Koningshuis");
        vraag2.addAntwoord(new Antwoord("Maxima"));
        mockedQuiz.addVraag(vraag2);

        Kortantwoordvraag vraag3 = new Kortantwoordvraag("In welk land is Christiano Ronaldo geboren?", "Voetbal");
        vraag3.addAntwoord(new Antwoord("Portugal"));
        mockedQuiz.addVraag(vraag3);

        MeerkeuzeVraag vraag4 = new MeerkeuzeVraag("Welke kleur krijg je als je rood en groen mengt?", "Kunst", "Blauw", "Paars", "Bruin", "Geel");
        mockedQuiz.addVraag(vraag4);

        MeerkeuzeVraag vraag5 = new MeerkeuzeVraag("Hoeveel liter is 1 kuub?", "Wiskunde", "100", "10", "10000", "1000");
        mockedQuiz.addVraag(vraag5);

        Kortantwoordvraag vraag6 = new Kortantwoordvraag("Welke artiesten zijn bekend van het nummer 'Het regent zonnestralen'?", "Muziek");
        ...
        Kortantwoordvraag vraag7 = new Kortantwoordvraag("Wat is het kleinste land ter wereld?", "Geografie");
        ...
        MeerkeuzeVraag vraag8 = new MeerkeuzeVraag("Hoe heet de schrijver van de Millennium-trilogie, een reeks misdaadromans? Het eerste boek uit de reeks heet\n" +
                "Mannen die vrouwen haten.", "Literatuur", "Henning Mankell", "Jo Nesbø", "Lars Kepler", "Stieg Larsson");
